...
<AssetFigure path="argentina/el-chalten-welcome.jpg" alt="Welcome sign in El Chalten" caption="Welcome to the capital of hiking." />
...
<AssetFigure path="argentina/laguna-de-los-tres-start.jpg" alt="Sign post at the start of the trail" caption="Sign post at the start of the trail." />
...
<AssetFigure path="argentina/laguna-de-los-tres-mirador.jpg" alt="Mount Fitz Roy in the clouds" caption="Be prepared for this as well :)" />
...
<AssetFigure path="argentina/laguna-de-los-tres-climb.jpg" alt="Trail going up the mountain" caption="The final climb is pretty steep." />

However, at the end of the climb you get rewarded with the most spectacular sight of Mount Fitz Roy and the lake.

<AssetFigure path="argentina/laguna-de-los-tres.jpg" alt="Laguna de Los tres and Mount Fitz Roy" caption="Laguna de Los Tres and Mount Fitz Roy." />
...
<AssetFigure path="argentina/laguna-sucia.jpg" alt="Laguna Sucia" caption="Laguna Sucia from above." />
...
<AssetFigure path="argentina/laguna-de-los-tres-evening.jpg" alt="Mount Fitz Roy viewpoint" caption="This was supposed to be the view in the morning." />
...
<AssetFigure path="argentina/fitz-roy-viewpoint.jpg" alt="Mount Fitz Roy viewpoint" caption="Climbing with Fitz Roy on your right side." />
...
<AssetFigure path="argentina/lenga-forest.jpg" alt="Lenga trees" caption="The trail continues through the forest." />
...
<AssetFigure path="argentina/loma-del-pliegue-tumbado-climb.jpg" alt="Alpine landscape" caption="Making our way through the alpine landscape." />

But the reward is there at the end of the climb. You get to an opening with a signpost: Loma del Pliegue Tumbado.

<AssetFigure path="argentina/loma-del-pliegue-tumbado-viewpoint.jpg" alt="Cerro Torre and Fitz Roy viewpoint" caption="The amazing viewpoint at the end of the trail." />
...
<AssetFigure path="argentina/lago-del-desierto-viewpoint.jpg" alt="Lago del Desierto viewpoint" caption="Lago del Desierto under light rain." />

<AssetFigure path="argentina/glacial-vespignani.jpg" alt="Vespignani hanging glacier" caption="Vespignani hanging glacier." />
...
<AssetFigure path="argentina/glacial-huemul.jpg" alt="Huemul lake and glacier" caption="Huemul lake and glacier." />
...
<AssetFigure path="argentina/always-glaciers-bus.jpg" alt="Always Glaciers Bus" caption="This is how the bus to El Calafate looks like." />
