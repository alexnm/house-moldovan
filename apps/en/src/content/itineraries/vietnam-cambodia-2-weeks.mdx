...
featured: false
coordinates:
  - { lat: 21.0278, lng: 105.8342, label: "Hanoi" }
  - { lat: 22.3364, lng: 103.8438, label: "Sapa" }
  - { lat: 20.9101, lng: 107.1839, label: "Ha Long Bay" }
  - { lat: 10.7769, lng: 106.7009, label: "Ho Chi Minh City" }
  - { lat: 13.3633, lng: 103.8564, label: "Siem Reap" }
  - { lat: 10.227, lng: 103.964, label: "Phu Quoc" }
---
