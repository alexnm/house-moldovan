...
summary: North to south through Vietnam's cities and rice terraces, then Angkor Wat and a few days unwinding on Phu Quoc's beaches.
country:
  - vietnam
  - cambodia
highlights:
  - "Wandering through the busy streets of Vietnam's cities"
  - "Vietnamese food is probably our favorite in the world"
  - "Angkor Wat is without a doubt the most impressive temple complex we've seen"
  - "Relaxing on the beaches of Phu Quoc"
travelTips:
  - "Weather in Vietnam varies from North to South, plan your trip accordingly."
  - "While both countries are rather poor, tourism is super well developed."
  - "We spent around €2200 per person back in 2018, flights included."
days:
  - locations: [vietnam/hanoi]
    description: "Land and start in the capital: first tastes of the street, the traffic, the pho."
  - locations: [vietnam/sapa]
    description: Transfer to the mountains of Sa Pa; rice terraces and village walks.
  - locations: [vietnam/sapa, vietnam/hanoi]
    description: "Return from Sa Pa, night in the city before moving on."
  - locations: [vietnam/ha-long-bay]
    description: Ha Long Bay cruise and overnight on the water among the karsts.
  - locations: [vietnam/ho-chi-minh-city]
    description: "End the cruise, bus to Hanoi, then fly to the south."
  - locations: [vietnam/ho-chi-minh-city]
    description: "War history day trip — museum, city sights, and the Cu Chi Tunnels from Ho Chi Minh City."
  - locations: [vietnam/ho-chi-minh-city]
    description: "Saigon in depth — old Saigon, markets, and the southern vibes."
  - locations: [vietnam/mekong-delta]
    description: Day trip into the delta from the city.
  - locations: [cambodia/siem-reap]
    description: Evening flight to the gateway to Angkor Wat.
  - locations: [cambodia/tonle-sap]
    description: "Countryside and lake — bikes, villages, and a floating community on Tonlé Sap."
  - locations: [cambodia/siem-reap]
    description: Full days at the Angkor Wat temple complex.
  - locations: [cambodia/siem-reap, vietnam/phu-quoc]
    description: "Sunrise at Angkor Wat, then flight to Phu Quoc."
  - locations: [vietnam/phu-quoc]
    description: Beach and rest in the Gulf of Thailand.
  - locations: [vietnam/phu-quoc]
    description: Another day by the water before the long hop north.
  - locations: [vietnam/hanoi]
    description: "Fly back to the start, last souvenirs, last bowls of pho, and goodbye for now."

months: "December–March"
published: 2020-06-16
hero: ../../assets/vietnam/buddha-mekong.jpg
heroLocation: vietnam/mekong-delta
---
...
<AssetFigure
  path="vietnam/ha-long-bay.jpg"
  alt="The view of Ha Long Bay from one of the islands."
  caption="The view of Ha Long Bay from one of the islands."
/>
...
<AssetFigure
  path="vietnam/saigon-notre-dame.JPG"
  alt="Notre Dame Cathedral in Ho Chi Minh City."
  caption="Notre Dame Cathedral in Ho Chi Minh City."
/>
...
<AssetFigure
  path="vietnam/cu-chi-tunnels.JPG"
  alt="The entrance to the tunnel that was open for tourists."
  caption="The entrance to the tunnel that was open for tourists."
/>
...
<Info type="warning">
  Don't forget insect-repellent and sunscreen, as you walk in the sun and
  through the jungle.
</Info>
...
<AssetFigure
  path="vietnam/saigon-cityhall.jpg"
  alt="The city hall of Ho Chi Minh City"
  caption="The city hall of Ho Chi Minh City."
/>
...
<AssetFigure
  path="vietnam/buddha-mekong.jpg"
  alt="Happy Buddha statue at Vinh Trang Temple."
  caption="Happy Buddha statue at Vinh Trang Temple."
/>
...
<AssetFigure
  path="vietnam/mekong-delta.JPG"
  alt="On a rowing boat in Mekong Delta."
  caption="On a rowing boat in Mekong Delta."
/>
...
<AssetFigure
  path="cambodia/children-at-school.JPG"
  alt="Children in a school break."
  caption="Children in a school break."
/>
...
<AssetFigure
  path="cambodia/floating-village.JPG"
  alt="Kompong Khleang floating village."
  caption="Kompong Khleang floating village."
/>
...
<AssetFigure
  path="cambodia/angkor-wat.jpg"
  alt="The main temple of Angkor Wat."
  caption="The main temple of Angkor Wat."
/>

We spent as much time as we could in the area, and we definitely recommend it to everyone as one of the most impressive travel destinations in the world. We wrote [this extensive story](/stories/angkor-wat-temples-guide) on Angkor Wat, with details on the various temples and spots that you should visit during your trip.
...
<AssetFigure
  path="vietnam/phu-quoc.JPG"
  alt="The beachfront in Phu Quoc."
  caption="The beachfront in Phu Quoc."
/>
...
<AssetFigure
  path="vietnam/lotte-tower-view.jpg"
  alt="View of Hanoi from the Lotte Observation Deck."
  caption="View of Hanoi from the Lotte Observation Deck."
/>
...
For their services especially, we highly recommend [La Selva hotel](https://www.booking.com/hotel/vn/the-jasmine.en-gb.htm) in Hanoi. We stayed there for just one night, because they had no room available for the night between our trips to Sa Pa and Ha Long Bay. They moved our luggage from one hotel to the other at no extra cost and they were very helpful with any question we had.
...
<AssetFigure
  path="vietnam/food.jpg"
  alt="Traditional lunch in Vietnam."
  caption="Traditional lunch in Vietnam."
/>
...
- [Pierdut în Vietnam & Cambodgia](https://www.goodreads.com/book/show/30255894-pierdut-in-vietnam-cambodgia) by Cătălin Vrabie (this in only in Romanian)
