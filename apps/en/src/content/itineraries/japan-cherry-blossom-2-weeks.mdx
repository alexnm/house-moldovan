...
days:
  ...
  - locations: [japan/kyoto]
    description: "Shinkansen to Kyoto — bullet train south; base in Kansai for the week ahead."
  - locations: [japan/himeji, japan/kobe]
    description: "Visit the white castle of Himeji, stop by the Akashi-Kaikyo bridge, and Kobe beef in one day."
  - locations: [japan/nara, japan/osaka]
    description: "Temples and deer feeding in Nara, Todai-ji giant Buddha statue, and Dotonbori evening energy."
  - locations: [japan/kyoto]
    description: "Kurama and Fushimi Inari — hill walk and endless torii; a long, stair-heavy day."
  - locations: [japan/kyoto]
    description: "A grand tour of Kyoto's most famous temples including Kiyomizu, Ryōan-ji, and the Golden Pavilion"
  - locations: [japan/kyoto]
    description: "Arashiyama and Gion — west-side nature and evening streets before saying goodbye to Kansai."
  - locations: [japan/takayama]
    description: A day in Takayama, a traditional Japanese town in the Japanese Alps.
  - locations: [japan/shirakawa-go]
    description: "Shirakawa-go and Okuhida — UNESCO gasshō hamlets, then up to the onsen cluster for the spa night."
  - locations: [japan/okuhida-onsen]
    description: "Shinhotaka Ropeway — cable cars and snow walls before another night in the high valley."
  - locations: [japan/matsumoto, japan/tokyo]
    description: "Quick stop in Matsumoto and return to Tokyo"
  - locations: [japan/tokyo]
    description: "Chuo, Tsukiji, Ginza, and hanami — sushi at dawn, Hamarikyu, Nakameguro, and a last walk under the cherry blossoms."

months: "March–April"
published: 2020-05-15
hero: ../../assets/japan/matsumoto.JPG
heroLocation: japan/matsumoto
---
