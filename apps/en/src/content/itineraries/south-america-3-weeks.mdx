...
summary: Three weeks across Argentina, Chile, and Uruguay — Patagonia hikes, Iguazú Falls, Santiago's Andean day trips, and colonial Montevideo.
country:
  - argentina
  - chile
  - uruguay
...
coordinates:
  ...
  - { lat: -49.3315, lng: -72.8863, label: "El Chaltén" }
  - { lat: -50.3379, lng: -72.2648, label: "El Calafate" }
  - { lat: -50.9423, lng: -73.4068, label: "Torres del Paine" }
  - { lat: -25.5977, lng: -54.5786, label: "Puerto Iguazú" }
  - { lat: -33.4489, lng: -70.6693, label: "Santiago" }
  - { lat: -34.9011, lng: -56.1645, label: "Montevideo" }
---
