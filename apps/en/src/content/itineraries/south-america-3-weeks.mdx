...
days:
  ...
  - locations: [argentina/buenos-aires]
    description: "La Boca: colour, football lore, later tango show."
  - locations: [argentina/el-chalten]
  ...
  - locations: [brazil/iguacu-falls, argentina/buenos-aires]
    description: "Brazilian side of the falls, then back to Buenos Aires for the night."
  - locations: [chile/santiago]
    description: Cross the Andes to Chile’s capital.
  - locations: [chile/santiago]
    description: "Plaza, palaces, and memory in a city built between the cordillera and the coast."
  - locations: [chile/cajon-del-maipo]
  ...
  - locations: [chile/valparaiso]
    description: "Day trip to Valparaíso — port, funiculars, and street art on the Pacific."
  - locations: [argentina/aconcagua]
  ...
  - locations: [uruguay/colonia-del-sacramento, argentina/buenos-aires]
...
heroLocation: argentina/perito-moreno
---
